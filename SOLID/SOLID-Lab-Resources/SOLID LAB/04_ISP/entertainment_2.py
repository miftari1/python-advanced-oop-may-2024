...
class Television(RCAConnector, HDMIConnector, POConnector):
...
class DVDPlayer(HDMIConnector, POConnector):
...
class GameConsole(HDMIConnector, EthernetConnector, POConnector):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EthernetConnector, POConnector):
    def connect_to_tv(self, television):
